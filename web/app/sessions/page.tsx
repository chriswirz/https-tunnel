...
import PruneSessions from '../../components/PruneSessions';
...
function List() {
  ...
  return (
    <Stack spacing={3}>
      <SessionsTable sessions={sessions} onDeleted={() => void refresh()} />
      {sessions.length > 0 && (
        <>
          <Divider />
          <div>
            ...
            <PruneSessions sessions={sessions} onPruned={() => void refresh()} />
          </div>
        </>
      )}
    </Stack>
